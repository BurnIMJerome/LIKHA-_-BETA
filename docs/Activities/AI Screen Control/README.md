...
AI Screen Control uses the configured AI provider, a screenshot of the current desktop, OCR, and Windows UI information to understand and operate visible applications using natural-language targets.
